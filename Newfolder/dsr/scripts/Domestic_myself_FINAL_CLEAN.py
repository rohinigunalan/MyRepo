...
TO RUN THIS SCRIPT:
Use: & "C:/Users/rgunalan/OneDrive - College Board/Documents/GitHub/MyRepo/Newfolder/.venv/Scripts/python.exe" -m pytest Domestic_myself_FINAL_CLEAN.py::TestPrivacyPortal::test_privacy_form_submission -v -s
...
class TestPrivacyPortal:
    ...
    def load_form_data(self):
        """Load ALL form data from Excel file for multiple records"""
    ...
    def fill_contact_information(self, page: Page):
        ...
        if not state_filled:
            ...
            # Take a screenshot to see current state
            page.screenshot(path=f"{SCREENSHOTS_DIR}\\state_field_debug.png", full_page=True)
            print(f"📸 Debug screenshot saved: {SCREENSHOTS_DIR}\\state_field_debug.png")
